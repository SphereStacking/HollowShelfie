  ...
  <FormSection @submitted="updateLogoInformation">
    ...
    <template #form>
      ...
      <div class="col-span-6 sm:col-span-4">
        <!-- ロゴファイルの隠し入力 -->
        <input
          ref="logoInput" type="file" class="hidden"
        ...
        <SecondaryButton class="mr-2 mt-2" type="button" @click.prevent="selectNewLogo">
          新しいロゴを選択
        </SecondaryButton>

        <SecondaryButton
          v-if="team.team_logo_path" type="button" class="mt-2"
