...
const dashboardItems = [
  ...
  { category: 'organize', iconType: 'event', title: 'イベントを主催する', url: route('event.create'), buttonText: 'go' },
  { category: 'organize', iconType: 'myEvents', title: 'イベント管理', url: route('event.manage'), buttonText: '表示' },
...
<template>
  <AppLayout title="Dashboard">
    ...
    <div class="mx-auto mb-10 grid w-full max-w-7xl  grid-cols-2 gap-5 sm:grid-cols-3  md:grid-cols-4 xl:grid-cols-6">
      <template v-for="category in dashboardCategory" :key="category.id">
        <div class="divider divider-start col-span-full text-xl font-semibold">
