...
1. 当サービスは、原則として無償で利用できます。利用にあたり対価等のお支払いが必要な場合には、別途表示する利用料金をお支払いいただきます。また、別途決済手段が指定されているときは、ユーザーはその決済手段に係る利用規約その他当該決済手段を利用するにあたり遵守すべき法的合意があるときは、当該法的合意も遵守しなければならないものとします。
